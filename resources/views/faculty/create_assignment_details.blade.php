                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <p class="card-text">{{ @$assignmentdetail->subject_name }}
                                                        </p>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <h5 class="card-title">Assignment Name</h5>
                                                        <p class="card-text">{{ @$assignmentdetail->assignment_name }}
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <br>
                                                {{-- {{$assignmentdetail->id}} --}}
                                                <a href="/update_assignment_details/{{ @$assignmentdetail->id }}"
                                                    class="btn btn-primary mt-3 my_mainpage_link">Edit</a>
