...
@section('content')
    ...
    <form class="" action="{{   route("student.submit_answer")}}" method="POST">
        @csrf
                ...
                <tr>
                    <th>
                        ...
                        <input type="hidden" name="question_id"
                            value="{{ $createdassignmentquestion->first()->questions }}">
                    </th>
                </tr>
                <tr>
                    <th>
                        <div>
                            ...
                            <textarea type="text" id="qanswer" name="qanswer" rows="6" class="form-control"
