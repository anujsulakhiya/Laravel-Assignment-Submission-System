...
<header class="jumbotron back-image"  style="background-image:url(assets/images/Banner3.jpg);" id="home" >
    ...
    <div class="col-md-12 text-center">
        <div class="myclass mainheding" >
            <h1 class="text-uppercase text-danger font-weight-bold text-shadow ">
            ...
            @if (Route::has('login'))
                ...
                <a href="#register" class="btn btn-danger mr-4">Register</a>
                @endauth
            @endif
        ...
        <div class="col-md-6 offset-md-3">
            <div class="card-body shadow p-4">
                <form method="POST" action="{{ route('register') }}" >
                    ...
                    <div class="form-group">
                        <i class="fa fa-key"></i><label for="password_confirmation" class="font-weight-bold pl-2">Confirm Password</label>
...
<div class="row ">
    <div class="col-md-6 mx-5 bg-light shadow p-4">
        <form action="./inc/user_query.php" method="POST">
            ...
            <input type="submit" class="btn btn-danger mt-3" name="send" value="Send">
        </form><br><br>
