<div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush">
            ...
            <a href="/home" class="list-group-item list-group-item-action bg-light"><i
                    class="fa fa-tachometer mr-2"></i>Dashboard</a>

            <a href="/profile" class="list-group-item list-group-item-action bg-light"><i
      ...
      <a href="/myassignment" class="list-group-item list-group-item-action bg-light"><i class="fa fa-book mr-2"></i>My Assignment</a> --}}
            ...
            <a href="/submitassignment" class="list-group-item list-group-item-action bg-light"><i
                    class="fa fa-file-text mr-2"></i>Submit Assignment</a>
    ...
    <div class="bg-light container-fluid">
        <div class="row">
            <nav style="padding: 0px;" class="container-fluid mb-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li><a class="text-primary" href="home"><i class="fa fa-home text-primary"></i> Home</a><i
                    ...
                    @else
                        <li class="breadcrumb-item active" aria-current="page">{{ @$studentbreadcumb }}</li>
                    @endif
                </ol>
            </nav>
